            ...
            <form action="/suratmasuk/save" method="post" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-md-6 mt-2">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('no_agenda')) ? 'is-invalid' : ''; ?>" id="no_agenda" name="no_agenda" value="<?= (old('no_agenda')) ? old('no_agenda') : sprintf("%03d", $no_agenda + 1); ?>">
                        ...
                        <input type="date" class="form-control <?= ($validation->hasError('tgl_terima')) ? 'is-invalid' : ''; ?>" id="tgl_terima" name="tgl_terima" value="<?= old('tgl_terima'); ?>">
                        <div class="invalid-feedback">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('no_smasuk')) ? 'is-invalid' : ''; ?>" id="no_smasuk" name="no_smasuk" value="<?= old('no_smasuk'); ?>">
                        <div class="invalid-feedback">
                        ...
                        <input type="date" class="form-control <?= ($validation->hasError('tgl_smasuk')) ? 'is-invalid' : ''; ?>" id="tgl_smasuk" name="tgl_smasuk" value="<?= old('tgl_smasuk'); ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <textarea class="form-control <?= ($validation->hasError('isi_surat')) ? 'is-invalid' : ''; ?>" id="isi_surat" name="isi_surat" rows="4"><?= old('isi_surat'); ?></textarea>
                        <div class="invalid-feedback">
                            <?= $validation->getError('isi_surat'); ?>
                        </div>

                        <label for="exampleInputPassword1" class="form-label mt-3">Retensi Aktif<sup> (opsional)</sup></label>
                        <input type="text" class="form-control" id="retensi_aktif" name="retensi_aktif" value="<?= old('retensi_aktif'); ?>">

                        <label for="exampleInputPassword1" class="form-label mt-3">Pengolah/Penyimpan<sup> (opsional)</sup></label>
                        <input type="text" class="form-control" id="pengolah" name="pengolah" value="<?= old('pengolah'); ?>">

                        <label for="exampleInputPassword1" class="form-label mt-3">File Surat<sup> (opsional)</sup></label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input <?= ($validation->hasError('file')) ? 'is-invalid' : ''; ?>" id="file" name="file" value="<?= old('file'); ?>" onchange="ambilnama()">
                            <div class="invalid-feedback">
                                <?= $validation->getError('file'); ?>
                            </div>
                            <label class="custom-file-label" for="File">File surat berupa pdf</label>
                            <small>
