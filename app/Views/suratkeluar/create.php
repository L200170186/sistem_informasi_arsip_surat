            ...
            <form action="/suratkeluar/save" method="post" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-md-6 mt-2">
                        ...
                        <input type="date" class="form-control <?= ($validation->hasError('tgl_skeluar')) ? 'is-invalid' : ''; ?>" id="tgl_skeluar" name="tgl_skeluar" value="<?= old('tgl_skeluar'); ?>">
                        <div class="invalid-feedback">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('no_skeluar')) ? 'is-invalid' : ''; ?>" id="no_skeluar" name="no_skeluar" value="<?= old('no_skeluar'); ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input <?= ($validation->hasError('file')) ? 'is-invalid' : ''; ?>" id="file" name="file" onchange="ambilnama()">
